Here’s your updated section with the new team details cleanly replaced:
...
* Build a 2D DP table of size (n+1) x (budget+1)
...
If you want, I can also format this into a polished GitHub README with badges, sections, and visuals.
